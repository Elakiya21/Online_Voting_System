...
<html>
   ...
   <body>
      ...
      <center>
         <h4 style="padding-top: 15px;">SEARCH EMPLOYEES</h4>
         <div  class="ser" style="padding-top: 20px;">
            <form action="EmployeeController" method="GET">
               ...
               <p id="error" style="color: red;">(Note:Contains,StartsWith,EndsWith is not applicable for Id and Age)</p>
               <div  style="padding-top: 20px;">
                  <input type="radio" id="contains" name="type" value="contains">
                  <label for="contains">Contains</label>
                  <input type="radio" id="StartsWith" name="type" value="StartsWith">
                  <label for="StartsWith">StartsWith</label>
                  <input type="radio" id="EndsWith" name="type" value="EndsWith">
                  <label for="EndsWith">EndsWith</label>
                  <input type="radio" id="Equal" name="type" value="Equal">
                  <label for="Equal">Equal</label>
                  <input type="radio" id="NotEqual" name="type" value="NotEqual">
                  <label for="NotEqual">NotEqual</label>
               </div>
               <div style="padding-bottom: 30px;padding-top: 20px;">
                  Enter the string to be searched :<input type="text" name="ch">
